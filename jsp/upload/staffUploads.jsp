...
<script type="text/javascript">
	...
	/*
	 * onClick function for staff upload
	 */
	function onUploadStaff(){

		bulkUploadBlockUI();
		document.staffUpload.action = 'staffUpload.htm';
		document.staffUpload.submit();
	}
	
	</script>
</head>
<body>
	<h:headerNew parentTabId="57" page="staffUploads.htm" />

	<div id="page_container">
		<div id="breadcrumb">
			<sec:authorize access="hasRole('Staff Uploads')">
				<ul>
					<li><a href="adminWelcome.htm"><spring:message
								code="application.home" />
					</a>&nbsp;&gt;&nbsp;</li>
					<li><spring:message code="BULK.UPLOAD.STAFF.IMPORTS" />
					</li>
				</ul>
			</sec:authorize>
		</div>
		<div class="help_link">
			<a href="#"
				onClick="PopupCenterScroll('<c:url value="resources/html/akura-help/topics/bulk/BulkStaffUpload.htm"/>','helpWindow',780,550)"><img
				src="resources/images/ico_help.png" width="20" height="20"
				align="absmiddle"> <spring:message code='application.help' />
			</a>
		</div>
		<div class="clearfix"></div>
		<h1><spring:message code="BULK.UPLOAD.STAFF.IMPORTS"/></h1>
		<div class="section_full_inside">	
		<div class="box_border">
		<div id="content_main">
			
			<form:form method="post" enctype="multipart/form-data"
				modelAttribute="bulkUploadedFile" action="staffUpload.htm" name="staffUpload">
				<input type="hidden" id="fileName" value ="${zipPath}"/>
				<input type="hidden" id="filePaths" value="${filePaths}" />
				<div class="section_box">
					<div class="section_box_header">
						<h2><spring:message code="BULK.UPLOAD.STAFF.IMPORTS.TITLE"/></h2>
					</div>
					<div class="messageArea">
						<label class="success_sign">${message}</label>
						<label class="required_sign">${stafferrmessage}</label>
					...
					<div id="singleColumn">
						<div class="row">
							...
							<div class="frmvalue">							
								<input name="staffUpload" type="file" style="width: 290px;" value="">								
							</div>
						</div>
						<div class="row">
							<div class="frmlabel">
							...
							<div class="frmvalue">
								<input type="button" OnClick="onUploadStaff();" value="Upload" class="button btnUpload" style="margin-left:0" />
							</div>
						</div>
					</div>
					<div class="clearfix"></div>
